...
import "slick-carousel/slick/slick-theme.css"; // Include slick theme
import './PropertyDetails.css'; // Your own styling
import axios from "axios";


import Navbar from '../../propertyplateautimes/components/Navbar'; // Corrected import path for Navbar
import Marquee from '../../propertyplateautimes/components/MarqueeTag'; // Corrected import path for Marquee

 // Function to extract the first 50 words
 const getPreview = (text) => {
  return text.split(" ").slice(0, 50).join(" ") + (text.split(" ").length > 50 ? "..." : "");
};
...
const PropertyDetails = ({ property, images, lastModifiedDate, description }) => {
  ...
  return (
    <div className="property-details">
      ...
      <div className="property-header">
        <h1>{property.title?.rendered || "Title not available"}</h1>
      ...
      {/* Property Description in a white box */}
      <div className="property-description-box">
        <h3>Property Description:</h3>
        {/* <div className="property-description">
          <div dangerouslySetInnerHTML={{ __html: description }} className={showFullDescription ? "full-description" : "short-description"} />
          <a href="#" className="read-more-link" onClick={toggleDescription}>
  ...
  {!showFullDescription ? (
    <p>
      {description.replace(/<\/?[^>]+(>|$)/g, "").split(" ").slice(0, 50).join(" ")}...
    </p>
  ) : (
 ...
 <div className="amenities-section">
        ...
        <div className="amenities-container">
          {property.property_features.map((featureId, index) => {
            const featureName = amenitiesTextMap[featureId] || `Unknown Amenity (ID: ${featureId})`;
            return (
              <div key={index} className="amenity-item">
                <img
                  src={amenitiesIconMap[featureName] || placeholderImage}
                  alt={featureName}
